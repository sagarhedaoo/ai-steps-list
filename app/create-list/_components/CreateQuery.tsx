...
const CreateQuery = ({ onSearchComplete }: CreateQueryProps) => {
  ...
  const handleSearchClick = async () => {
    ...
    // await animate("#headline", { y: -350 }, { duration: 0.2 });
  ...
  return (
    ...
    >
      <h3
        id="target"
        className="bg-gradient-to-r from-[#833ab4] to-[#fd1d1d] via-[#fcb045] bg-clip-text text-transparent text-8xl font-roboto mt-5"
      >
        ASK AI
      </h3>
      <div id="target" className=" flex justify-center items-center py-4 px-5 ">
        <div className="w-[900px] flex items-center justify-center bg-gradient-to-r from-[#833ab4] to-[#fd1d1d] via-[#fcb045] rounded-2xl p-1">
          ...
          />
          <button
            className="cursor-pointer hover:bg-red-400 hover:rounded-2xl mx-2 p-3"
